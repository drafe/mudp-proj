...
filename = 'cow.jpg' # Set the file name
with Image.open(filename) as img_cow: # Open file
    img_cow.load()                    # Open like PIL image

filename = 'monk.jpg' # Set the file name
with Image.open(filename) as img_monk: # Open file
    img_monk.load() 
